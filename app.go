...
var (
	...
	DefaultCLIHome = os.ExpandEnv("$HOME/.trustcli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.trustd")
...
func NewLcnemintApp(
	...
	keys := sdk.NewKVStoreKeys(bam.MainStoreKey, auth.StoreKey, staking.StoreKey,
		supply.StoreKey, distr.StoreKey, slashing.StoreKey, nft.StoreKey, trust.StoreKey, params.StoreKey)
